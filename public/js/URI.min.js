...
(function (f, m) { "object" === typeof module && module.exports ? module.exports = m() : "function" === typeof define && define.amd ? define(m) : f.IPv6 = m(f) })(this, function (f) {
    var m = f && f.IPv6;
    return {
        best: function (h) {
            ...
            var k = -1,
                ...
                g = -1,
                p = !1;
            for (q = 0; q < b; q++) p ? "0" === h[q] ? m += 1 : (p = !1, m > f && (k = g, f = m)) : "0" === h[q] && (p = !0, g = q, m = 1);
            m > f && (k = g, f = m);
            1 < f && h.splice(k, f, "");
            k = h.length;
            b = "";
        ...
        noConflict: function () { f.IPv6 === this && (f.IPv6 = m);
            return this }
    }
});
(function (f) {
    ...
    function g(b) {
        ...
        var n = b.lastIndexOf("-");
        0 > n && (n = 0);
        for (c = 0; c < n; ++c) 128 <= b.charCodeAt(c) && m("not-basic"), g.push(b.charCodeAt(c));
        for (n = 0 < n ? n + 1 : 0; n < h;) {
            c = f;
            var l = 1;
            for (d = 36;; d += 36) {
        ...
        for ((h = f = p.length) && p.push("-"); h < a;) {
            ...
            for (k = 0; k < a; ++k)
                if (l = g[k], l < c && 2147483647 < ++d && m("overflow"), l == c) {
                    var r = d;
                    for (x = 36;; x += 36) { l = x <= n ? 1 : x >= n + 26 ? 26 : x - n;
                        if (r < l) break;
                        var A = r - l;
                        r = 36 - l;
                        p.push(t(z(l + A % r, 0)));
...
(function (f, m) { "object" === typeof module && module.exports ? module.exports = m() : "function" === typeof define && define.amd ? define(m) : f.SecondLevelDomains = m(f) })(this, function (f) {
    var m = f && f.SecondLevelDomains,
        h = {
            ...
            noConflict: function () { f.SecondLevelDomains === this && (f.SecondLevelDomains = m);
                return this }
        };
    return h
});
(function (f, m) { "object" === typeof module && module.exports ? module.exports = m(require("./punycode"), require("./IPv6"), require("./SecondLevelDomains")) : "function" === typeof define && define.amd ? define(["./punycode", "./IPv6", "./SecondLevelDomains"], m) : f.URI = m(f.punycode, f.IPv6, f.SecondLevelDomains, f) })(this, function (f, m, h, k) {
    function b(a, c) {
    ...
    function g(a, c) {
        ...
        if ("RegExp" === z(c)) d = null;
            ...
            var l = 0;
            for (b = c.length; l < b; l++) d[c[l]] = !0 } else d[c] = !0;
        l = 0;
        for (b = a.length; l < b; l++)
            if (d && void 0 !== d[a[l]] || !d && c.test(a[l])) a.splice(l, 1), b--, l--;
        return a
    }
    ...
    function p(a, c) {
        ...
        for (d = a.length; b < d; b++)
            if ("RegExp" === l) {
                if ("string" === typeof a[b] && a[b].match(c)) return !0 } else if (a[b] === c) return !0;
        return !1 }
    ...
    b.findUri = { start: /\b(?:([a-z][a-z0-9.+-]*:\/\/)|www\.)/gi, end: /[\s\r\n]|$/, trim: /[`!()\[\]{};:'".,<>?\u00ab\u00bb\u201c\u201d\u201e\u2018\u2019]+$/, parens: /(\([^\)]*\)|\[[^\]]*\]|\{[^}]*\}|<[^>]*>)/g };
    b.defaultPorts = {
        http: "80",
        https: "443",
        ftp: "21",
    ...
    b.domAttributes = { a: "href", blockquote: "cite", link: "href", base: "href", script: "src", form: "action", img: "src", area: "href", iframe: "src", embed: "src", source: "src", track: "src", input: "src", audio: "src", video: "src" };
    ...
    b.iso8859 =
        function () { b.encode = escape;
            b.decode = unescape };
    b.unicode = function () { b.encode = E;
        b.decode = decodeURIComponent };
    b.characters = {
    ...
    b.decodeQuery =
        function (a, c) { a += "";
            void 0 === c && (c = b.escapeQuerySpace);
            try {
                return b.decode(c ? a.replace(/\+/g, "%20") : a) } catch (d) {
                return a } };
    ...
    b.parse = function (a, c) {
        ...
        d = a.indexOf("?"); - 1 < d && (c.query = a.substring(d + 1) || null, a = a.substring(0, d));
        "//" ===
    ...
    b.parseHost = function (a, c) {
        ...
        if ("[" === a.charAt(0)) {
            ...
            c.port =
                a.substring(n + 2, d) || null;
            "/" === c.port && (c.port = null)
        } else {
            var l = a.indexOf(":");
            n = a.indexOf("/");
            l = a.indexOf(":", l + 1); - 1 !== l && (-1 === n || l < n) ? (c.hostname = a.substring(0, d) || null, c.port = null) : (n = a.substring(0, d).split(":"), c.hostname = n[0] || null, c.port = n[1] || null) }
    ...
    b.parseAuthority = function (a, c) { a = b.parseUserinfo(a, c);
        return b.parseHost(a, c) };
    b.parseUserinfo = function (a, c) {
        var d = a.indexOf("/"),
            n = a.lastIndexOf("@", -1 < d ? d : a.length - 1); - 1 < n && (-1 === d || n < d) ? (d = a.substring(0, n).split(":"), c.username = d[0] ? b.decode(d[0]) : null, d.shift(), c.password = d[0] ? b.decode(d.join(":")) : null, a = a.substring(n + 1)) : (c.username = null, c.password = null);
        return a };
    b.parseQuery = function (a, c) {
        ...
        for (var d = {}, n = a.split("&"), l = n.length, e, g, f = 0; f < l; f++)
            if (e = n[f].split("="), g = b.decodeQuery(e.shift(),
                    c), e = e.length ? b.decodeQuery(e.join("="), c) : null, t.call(d, g)) {
                if ("string" === typeof d[g] || null === d[g]) d[g] = [d[g]];
                d[g].push(e) } else d[g] = e;
        return d
    };
    b.build = function (a) {
        var c = "";
        ...
        c += b.buildAuthority(a) || ""; "string" === typeof a.path && ("/" !== a.path.charAt(0) && "string" === typeof a.hostname && (c += "/"), c += a.path); "string" === typeof a.query && a.query && (c += "?" + a.query); "string" === typeof a.fragment && a.fragment && (c += "#" + a.fragment);
        return c };
    b.buildHost =
        function (a) {
            var c = "";
        ...
        for (l in a)
            if (t.call(a, l) && l)
                if (u(a[l])) {
                    var g = {};
                    var f = 0;
                    for (e = a[l].length; f < e; f++) void 0 !== a[l][f] &&
                        void 0 === g[a[l][f] + ""] && (n += "&" + b.buildQueryParameter(l, a[l][f], d), !0 !== c && (g[a[l][f] + ""] = !0))
                } else void 0 !== a[l] && (n += "&" + b.buildQueryParameter(l, a[l], d));
    ...
    b.addQuery = function (a, c, d) {
        ...
        else if ("string" === typeof c) void 0 === a[c] ? a[c] = d : ("string" === typeof a[c] && (a[c] = [a[c]]), u(d) || (d = [d]), a[c] = (a[c] || []).concat(d));
        else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");
    };
    b.removeQuery = function (a, c, d) {
        var n;
        if (u(c))
            for (d = 0, n = c.length; d < n; d++) a[c[d]] = void 0;
        else if ("RegExp" === z(c))
            for (n in a) c.test(n) && (a[n] = void 0);
    ...
    b.hasQuery = function (a, c, d, n) {
        switch (z(c)) {
            ...
            case "RegExp":
                for (var l in a)
                    if (t.call(a, l) && c.test(l) && (void 0 === d || b.hasQuery(a, l, d))) return !0;
                return !1;
            case "Object":
                for (var e in c)
    ...
    b.joinPaths = function () {
        for (var a = [], c = [], d = 0, n = 0; n < arguments.length; n++) {
            var l =
                new b(arguments[n]);
            a.push(l);
            for (var l = l.segment(), e = 0; e < l.length; e++) "string" === typeof l[e] && c.push(l[e]), l[e] && d++
        }
    ...
    b.commonPath = function (a, c) {
        var d = Math.min(a.length, c.length),
            b;
        for (b = 0; b < d; b++)
            if (a.charAt(b) !== c.charAt(b)) { b--;
                break }
        if (1 > b) return a.charAt(0) === c.charAt(0) && "/" === a.charAt(0) ? "/" : "";
        if ("/" !== a.charAt(b) || "/" !== c.charAt(b)) b = a.substring(0,
            b).lastIndexOf("/");
    ...
    b.withinString = function (a, c, d) {
        ...
        for (n.lastIndex = 0;;) {
            ...
            p = -1 < m ? p.slice(0, m) + p.slice(m).replace(e,
                "") : p.replace(e, "");
            p.length <= h[0].length || d.ignore && d.ignore.test(p) || (m = k + p.length, h = c(p, k, m, a), void 0 === h ? n.lastIndex = m : (h = String(h), a = a.slice(0, k) + h + a.slice(m), n.lastIndex = k + h.length))
        }
        n.lastIndex = 0;
        return a
    };
    b.ensureValidHostname = function (a, c) {
        ...
        if (e && !d) throw new TypeError("Hostname cannot be empty, if protocol is " + c);
    ...
    b.noConflict = function (a) {
        if (a) return a = { URI: this.noConflict() }, k.URITemplate && "function" === typeof k.URITemplate.noConflict && (a.URITemplate = k.URITemplate.noConflict()), k.IPv6 && "function" === typeof k.IPv6.noConflict &&
            (a.IPv6 = k.IPv6.noConflict()), k.SecondLevelDomains && "function" === typeof k.SecondLevelDomains.noConflict && (a.SecondLevelDomains = k.SecondLevelDomains.noConflict()), a;
        k.URI === this && (k.URI = w);
        return this
    };
    e.build = function (a) {
    ...
    e.pathname = function (a, c) {
        ...
        this._parts.path = this._parts.urn ?
            a ? b.recodeUrnPath(a) : "" : a ? b.recodePath(a) : "/";
        this.build(!c);
        return this
    };
    e.path = e.pathname;
    e.href = function (a, c) {
        ...
        if ("string" === typeof a || a instanceof String) this._parts = b.parse(String(a), this._parts);
            ...
            for (d in e = e ? a._parts : a, e) t.call(this._parts,
                d) && (this._parts[d] = e[d]);
    ...
    e.is = function (a) {
        var c = !1,
            ...
            k = !1,
            p = !this._parts.urn;
        this._parts.hostname && (p = !1, d = b.ip4_expression.test(this._parts.hostname), e = b.ip6_expression.test(this._parts.hostname), c = d || e, g = (l = !c) && h && h.has(this._parts.hostname), f = l && b.idn_expression.test(this._parts.hostname), k = l && b.punycode_expression.test(this._parts.hostname));
    ...
    e.tld = function (a, c) {
        ...
        if (a)
            ...
            this._parts.hostname = this._parts.hostname.replace(b, a) } else throw new TypeError("cannot set TLD empty");
        this.build(!c);
        return this
    };
    ...
    e.filename = function (a, c) {
        ...
        d = !1; "/" === a.charAt(0) && (a = a.substring(1));
        a.match(/\.?\//) && (d = !0);
    ...
    e.segmentCoded = function (a, c, d) {
        ...
        if (void 0 === c) { a = this.segment(a, c, d);
            if (u(a)) {
                var g = 0;
                for (e = a.length; g < e; g++) a[g] = b.decode(a[g]) } else a = void 0 !== a ? b.decode(a) : void 0;
            return a }
        if (u(c))
    ...
    e.addQuery = function (a, c, d) {
        ...
        this._parts.query = b.buildQuery(e, this._parts.duplicateQueryParameters, this._parts.escapeQuerySpace); "string" !== typeof a && (d = c);
        this.build(!d);
        return this };
    ...
    e.normalizeProtocol = function (a) { "string" === typeof this._parts.protocol && (this._parts.protocol = this._parts.protocol.toLowerCase(), this.build(!a));
        return this };
    e.normalizeHostname = function (a) { this._parts.hostname && (this.is("IDN") && f ? this._parts.hostname = f.toASCII(this._parts.hostname) : this.is("IPv6") && m && (this._parts.hostname = m.best(this._parts.hostname)), this._parts.hostname = this._parts.hostname.toLowerCase(), this.build(!a));
        return this };
    ...
    e.normalizeFragment = function (a) { this._parts.fragment || (this._parts.fragment = null, this.build(!a));
        return this };
    ...
    e.iso8859 = function () {
        ...
        b.encode = escape;
        b.decode = decodeURIComponent;
        try { this.normalize() } finally { b.encode = a, b.decode = c }
        return this };
    e.unicode = function () {
        var a = b.encode,
            c = b.decode;
    ...
    e.readable = function () {
        ...
        if (a._parts.query) {
            for (var d = "", e = 0, g = a._parts.query.split("&"), h = g.length; e < h; e++) {
                var k = (g[e] || "").split("="),
                    d = d + ("&" + b.decodeQuery(k[0], this._parts.escapeQuerySpace).replace(/&/g,
                        "%26"));
    ...
    e.equals = function (a) {
        ...
        for (e in c)
            if (t.call(c,
                    e)) {
                if (!u(c[e])) {
                    if (c[e] !== f[e]) return !1 } else if (!D(c[e], f[e])) return !1;
                a[e] = !0 }
        for (e in f)
            if (t.call(f, e) && !a[e]) return !1;
        return !0
    };
    e.duplicateQueryParameters = function (a) { this._parts.duplicateQueryParameters = !!a;
        return this };
    e.escapeQuerySpace = function (a) { this._parts.escapeQuerySpace = !!a;
        return this };
    return b
});
(function (f, m) { "object" === typeof module && module.exports ? module.exports = m(require("./URI")) : "function" === typeof define && define.amd ? define(["./URI"], m) : f.URITemplate = m(f.URI, f) })(this, function (f, m) {
    function h(b) {
    ...
    h.expand = function (b, f, k) {
        ...
        for (q = 0; r = b[q]; q++) {
            ...
            if (w.val.length) {
                ...
                m.push(h["expand" + p](w, g, r.explode, r.explode && g.separator || ",", r.maxlength, r.name)) } else w.type && m.push("")
        }
    ...
    h.noConflict = function () { m.URITemplate === h && (m.URITemplate = b);
        return h };
    z.expand = function (b, f) {
        var g = "";
        this.parts && this.parts.length || this.parse();
        b instanceof k || (b = new k(b));
        for (var p = 0, m = this.parts.length; p < m; p++) g += "string" === typeof this.parts[p] ? this.parts[p] : h.expand(this.parts[p], b, f);
        return g };
    z.parse = function () {
        var b =
            this.expression,
        ...
        for (f.lastIndex = 0;;) {
            var w = f.exec(b);
            if (null === w) { z.push(C(b.substring(r)));
                break } else z.push(C(b.substring(r, w.index))), r = w.index + w[0].length;
            ...
            for (var t = 0, y = e.length; t <
                ...
                if (v[1].match(m)) throw Error('Invalid Variable Name "' + v[1] + '" in "' + w[0] + '"');
                e[t] = { name: v[1], explode: !!v[3], maxlength: v[4] && parseInt(v[4], 10) } }
    ...
    k.prototype.get = function (b) {
        ...
        if (void 0 !== f && null !== f)
            if ("[object Array]" === String(Object.prototype.toString.call(f))) {
                ...
                g.val.length && (g.type = 3) } else if ("[object Object]" === String(Object.prototype.toString.call(f))) {
            for (h in f) q.call(f,
